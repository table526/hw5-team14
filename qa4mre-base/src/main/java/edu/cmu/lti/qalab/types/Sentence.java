...
public class Sentence extends Annotation {
  ...
  public FSList getVerbList() {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_verbList == null)
      jcasType.jcas.throwFeatMissing("verbList", "edu.cmu.lti.qalab.types.Sentence");
    return (FSList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Sentence_Type)jcasType).casFeatCode_verbList)));}
  ...
  public void setVerbList(FSList v) {
    if (Sentence_Type.featOkTst && ((Sentence_Type)jcasType).casFeat_verbList == null)
      jcasType.jcas.throwFeatMissing("verbList", "edu.cmu.lti.qalab.types.Sentence");
    jcasType.ll_cas.ll_setRefValue(addr, ((Sentence_Type)jcasType).casFeatCode_verbList, jcasType.ll_cas.ll_getFSRef(v));}    
  }
